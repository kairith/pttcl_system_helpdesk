...
import { TicketCount } from "@/app/backend/lib/types";
...
export default function Dashboard({ isSidebarOpen }: DashboardProps) {
  ...
  const chartConfig = {
    ...
    options: {
      ...
      plugins: {
        ...
        title: {
          display: true,
          text: "Monthly Tickets Opened in 2024",
          font: {
            size: 18,
            family: "'Inter', sans-serif",
