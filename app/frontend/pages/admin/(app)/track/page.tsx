...
interface Ticket {
  ...
  comment: string | null;
  users_name: string | null; // assignee name
  status: string | null;
  ...
  user_create_ticket: string | null; // creator id (FK to tbl_users.users_id)
  created_by_name: string | null; // <— NEW (from cu.users_name)
}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-full">
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-800 break-words min-w-0">
                      {ticket.ticket_id}
                    </p>
                  </div>
                  <div>
