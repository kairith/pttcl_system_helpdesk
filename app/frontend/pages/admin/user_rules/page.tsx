...
export default function UserRules({ isSidebarOpen }: UserRulesProps) {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        ...
        console.log(
          "AdminUserRulesPage: Fetching with token:",
        ...
        console.log(
          "AdminUserRulesPage: Permissions:",
        ...
        console.log(
          "AdminUserRulesPage: Fetched rules:",
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/data/roles/${selectedRule.rules_id}/delete`,
        {
          method: "DELETE",
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  console.log(
    "AdminUserRulesPage: Filtered rules:",
                    ...
                    >
                      ...
                      <tbody>
                        {filteredRules.map((row, index) => (
                          ...
                          >
                            <td
                              className="p-3 sm:p-4 text-gray-700"
                              scope="row"
                            >
                              {index + 1}
                            </td>
