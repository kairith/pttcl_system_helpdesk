...
export default function AddStation() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!station_id.trim() || !station_name.trim() || !station_type.trim() || !province.trim()) {
    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-blue-100">
      ...
      <div className="flex justify-center items-center min-h-[calc(100vh-64px)]">
        <div className="w-full max-w-4xl bg-white rounded-xl shadow-lg p-6 sm:p-8 ">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-6 text-center">Add Station</h1>
